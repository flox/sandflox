...
- [ ] **KERN-07**: sandflox allows localhost connections when `network.allow-localhost = true` even when network is blocked
- [ ] **KERN-08**: sandflox allows Unix socket communication (Nix daemon) when network is blocked
