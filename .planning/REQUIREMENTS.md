...
- [x] **CMD-03**: `sandflox elevate` from within a `flox activate` session re-execs the current shell under sandbox-exec with generated SBPL (one-time bounce with re-entry detection)
